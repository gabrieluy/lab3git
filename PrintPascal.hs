...
instance Print Program where
  prt i e = case e of
    PBlock id varpart stms -> prPrec i 0 (concatD [doc (showString "program"), prt 0 id, doc (showString ";"), prt 0 varpart, doc (showString "begin"), prt 0 stms, doc (showString "end"), doc (showString ".")])
...
instance Print Exp where
  prt i e = case e of
    ETyped exp type_ -> prPrec i 0 (concatD [doc (showString "["), prt 0 exp, doc (showString ":"), prt 0 type_, doc (showString "]")])
    EConv exp -> prPrec i 0 (concatD [doc (showString "("), prt 0 exp, doc (showString ")")])
